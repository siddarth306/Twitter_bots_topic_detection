...
function displayTask1PieChart() {

  // Map is used for displaying percentage in legend.
  var tweetsData = new Map();
  tweetsData.set("English Tweets", 7327499);
  tweetsData.set("Non English Tweets" , 154669);

  var dataset = [
      {label: "English Tweets", count: 7327499},
      {label: "Non English Tweets", count: 154669},
    ];
  ...
  var svg = d3.select('#task1_piechart')
    .append('svg') 
    .attr('width', width) 
    .attr('height', height) 
    .append('g') 
  ...
  var tooltip = d3.select('#task1_piechart') 
    .append('div') 
    .attr('class', 'tooltip');
